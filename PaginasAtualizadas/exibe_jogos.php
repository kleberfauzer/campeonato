...
?>
	<body>
	<link href="css/exibejogos.css" rel="stylesheet">
	<link href="css/tabela3_css.css" rel="stylesheet">
	<h2>Escolha o campeonato para ver os jogos</h2>
	<br />
	<form action = "" method = "post">
	
		<select class = "select" id="appearance-select" name = "id_campeonato">
...
<?php		
		if(isset($_POST["id_campeonato"])){
			...
			$id = $_POST["id_campeonato"];
				...
				if($registros == 0){
					echo "<script> alert('Não há jogos gerados para este campeonato'); </script>";
				}else{
?>
